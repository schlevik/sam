dollar = {
    ...
    "VBD": {
        ...
        "goal": ['shot in', "curled in", "put (in)", "hammered in", "drilled in", "slotted in"],
        "score": ["scored", "hit"],
    ...
    "VBG": {
        "goal": ["hammering in", "curling in", "slotting in", 'drilling in', 'putting in'],
        "score": ['scoring", "hitting'],
